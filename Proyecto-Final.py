...
Los resultados obtenidos con el código anterior se pueden ver en la siguiente figura.""")
    ...
    with col1:               # To display the header text using css style
        ...
        st.write("""La correlacion de pearson sirve para calcular la correlacion de dos datos en general se trata de 'x' y ',Para una busqueda de muchos datos, este seria efectivo ,ya que esta destinado al uso de 2 datos y esta se puede aplicar a una secuencia, además que las variables que se nesesita deben ser medidas a un nivel cuantitativo continuo. Ademas la distribucion de las variables deben ser semejantes a la curva normal. Buscamos la compracion entre dos datos para ver si coinciden en diferentes aspectos""")

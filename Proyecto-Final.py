...
Los resultados obtenidos con el código anterior se pueden ver en la siguiente figura.""")
    ...
    with col1:               # To display the header text using css style
        ...
        st.write("""La correlacion de pearson sirve para calcular la correlacion de dos datos en general se trata de 'x' y ',Para una busqueda de muchos datos, esta no seria efectivo ,ya que esta destinado al uso de 2 datos, además que las variables que se nesesita deben ser medidads a un nivel cuantitativo continuo. Ademas la distribucion de las variables deben ser semejantes a la curva normal. A menos que buaquemos la compracion entre dos datos para ver si coinciden en difernetes aspectos""")

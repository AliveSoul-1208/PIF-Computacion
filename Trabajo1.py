...
expander = st.expander(" **Datos del dataframe 'NAN'** ")
...
expander = st.expander(" **Eliminando columnas con NAN** ")
...
expander = st.expander(" **Reemplazando valores perdidos de NAN** ")
...
expander = st.expander(" **Tabla limpia de NAN** ")
expander.dataframe(data_f)
...
expander = st.expander(" **Tabla de Correlacion de PANDAS** ")
...
expander = st.expander(" **ARRAY de la correlacion** ")
...
expander = st.expander(" **Correlacion Nuestra Convertida** ")

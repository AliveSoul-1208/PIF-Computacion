...
Los resultados obtenidos con el código anterior se pueden ver en la siguiente figura.""")
    ...
    with col1:               # To display the header text using css style
        ...
        st.write("""La correlacion de pearson se usa para calcular la correlacion de dos datos en general se trata de 'x' y ',Para una busqueda de muchos datos esta no seria efectivo ,ya que esta destinado al uso de 2 datos,ademas que las variables que se nesesita deben ser medidas a un nivel cuantitativo continuo. Ademas la distribucion de las variables deben ser semejantes a la curva normal. A menos que busquemos la comparacion entre dos datos para ver si coinciden en diferentes aspectos""")
